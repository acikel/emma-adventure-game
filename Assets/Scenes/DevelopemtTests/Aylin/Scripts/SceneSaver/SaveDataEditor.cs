...
public class SaveDataEditor : Editor
{
    ...
    private Action<Sprite> spriteSpecificGUI;           // Delegate for the GUI that represents Sprite values.
    ...
    private void OnEnable()
    {
        ...
        spriteSpecificGUI = value => { EditorGUILayout.LabelField(value.ToString()); };
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        KeyValuePairListsGUI("Sprites", saveData.spriteKeyValuePairLists, spriteSpecificGUI);
    }
